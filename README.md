...
Chord-visualizable Musical Chord Instrument on the Circle-of-fifths Clock for web browser,
with MIDI(SMF) player, and embedded player linked to [Songle Widget](http://widget.songle.jp/).
